...
let M_Impressions = [
    ...
    M_Impression(name: "Scarlett O'Hara", type: .Movie, subtitle: "Gone with the Wind", script: "As God is my witness, I'll never be hungry again.", complete: false, imageName: "Scarlett", gen: 2),
    M_Impression(name: "Forrest Gump", type: .Movie, subtitle: "Forrest Gump", script: "My mama always said life was like a box of chocolates. You never know what you're gonna get.", complete: false, imageName: "Forrest" , gen: 0),
    ...
    M_Impression(name: "Charlie Chaplin", type: .Star, subtitle: "The Great Dictator", script: "You, the people, have the power to make this life free and beautiful, to make this life a wonderful adventure.", complete: false, imageName: "Charlie", gen: 2),
